  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">Review all past lectures you've attended.</p>
      </div>
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-12 text-center">
        <span className="text-6xl block mb-4">📼</span>
        <h3 className="text-lg font-semibold text-slate-700 mb-2">Lecture History</h3>
